...
class Test2 {
	...
	void up(int n3) {
		...
		n2 += 1;
		n3 += 1;
		System.out.println("n1 : " + n1);	// 멤버 필드 : 객체 소멸전까지 유지됨
		System.out.println("n2 : " + n2);	// 지역 변수 : 함수 실행 시 생성되고 종료되면 소멸함
		System.out.println("n3 : " + n3);	// 매개 변수 : 함수 실행 시 값이 지정되고 종료되면 소멸함
