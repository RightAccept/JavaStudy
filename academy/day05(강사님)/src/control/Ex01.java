...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 2) 반복문 : 조건에 따라서 일정 구간의 코드를 반복수행할 수 있다
		// 3) 기타 제어문 : 반복을 중단하거나, 함수를 중단할 수 있다.
		...
		if(select == 2) {
			System.out.println("3-2) 지금은 잔다");
			System.out.println("3-2) 내일 베낀다");
		}
		...
		//			종속문장은 한 줄일 수도 있고, 여러줄일 수도 있다
		//			종속문장이 한 줄이라면 {}를 생략할 수 있으나, 권장하지 않는다
	}
}
